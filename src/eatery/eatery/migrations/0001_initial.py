# Generated by Django 3.0.3 on 2020-03-05 17:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='更新日時')),
                ('enabled', models.BooleanField(default=True, verbose_name='有効')),
                ('status', models.IntegerField(choices=[(0, '未確定'), (1, '決済終了')], default=0)),
                ('products', models.ManyToManyField(blank=True, through='eatery.Order', to='eatery.Product')),
        ...
        migrations.AddField(
            model_name='product',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='eatery.ProductCategory'),
        ),
        migrations.AddField(
            model_name='product',
            name='eatery',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eatery.Eatery'),
        ),
        migrations.AddField(
            model_name='order',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eatery.Product'),
        ),
        migrations.AddField(
            model_name='order',
            name='voucher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eatery.Voucher'),
        ),
        migrations.CreateModel(
            name='Reservation',
            fields=[
                ...
                ('tel', models.CharField(max_length=128)),
                ('table', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eatery.Table')),
                ('voucher', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='eatery.Voucher')),
